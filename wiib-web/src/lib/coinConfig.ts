...
export const COIN_MAP: Record<string, CoinCfg> = {
  ...
  XAUUSDT: {
    symbol: 'XAUUSDT', name: '黄金', pair: 'XAU / USDT', tvSymbol: 'TVC:GOLD', futuresTvSymbol: 'BINANCE:XAUUSDT',
  ...
  CLUSDT: {
    symbol: 'CLUSDT', name: '原油', pair: 'CL / USDT', tvSymbol: 'TVC:USOIL', futuresTvSymbol: 'BINANCE:CLUSDT',
    minQty: 0.001, icon: Fuel,
